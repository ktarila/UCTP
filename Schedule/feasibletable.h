...
private:
	...
	constexpr static double alpha = 1;      //heuristic weight -- high Ants less sensitive to pheromone trail more sensitive to heuristics
	constexpr static double beta = 9;       //trail weight     -- high means ants are less sensitive to heuristic more senstive to pheromone trail
	constexpr static double rho = 0.005;        //rate of evapouration -- high means fast evapouration rate (range between 0 and 1);
